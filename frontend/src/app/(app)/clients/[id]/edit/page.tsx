...
export default function EditClientPage() {
  ...
  useEffect(() => {
    api.get<Client>(`/clients/${id}`).then((c) => {
      setForm({ name: c.name, phone: c.phone || '', cin: c.cin || '', address: c.address || '', notes: c.notes || '' });
  ...
  return (
    <div className="mx-auto max-w-2xl p-6 lg:p-8">
      <h1 className="mb-6 text-2xl font-bold text-slate-950">Edit Client</h1>
