 ...
 *
 * Theme state is driven by next-themes (persistent, no flash, no hydration issues).
 */
...
export function AnimatedThemeToggler({
  ...
  // `initial={false}` on every motion element already prevents an on-mount
  // animation, so a constant spring is safe (no first-render special-casing).
