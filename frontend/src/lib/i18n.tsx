...
const fr: Partial<Dict> = {
  ...
  actions: { ...arDict.actions, new: "Nouveau", create: "Créer", save: "Enregistrer", edit: "Modifier", update: "Mettre à jour", delete: "Supprimer", cancel: "Annuler", close: "Fermer", search: "Rechercher", filter: "Filtrer", upload: "Importer", download: "Télécharger", view: "Voir", saving: "Enregistrement...", loading: "Chargement...", uploading: "Import...", retry: "Réessayer" },
  labels: { ...arDict.labels, name: "Nom", email: "Email", phone: "Téléphone", address: "Adresse", notes: "Notes", description: "Description", date: "Date", status: "Statut", type: "Type", category: "Catégorie", none: "Aucun", noData: "Aucune donnée", noResults: "Aucun résultat", success: "Opération réussie" },
  ...
  stock: { ...arDict.stock, title: "Stock", materials: "Matériaux", categories: "Catégories", newMaterial: "Nouveau matériau", currentQty: "Quantité actuelle", lowStock: "Stock faible", movements: "Mouvements", materialCatalog: "Catalogue matériaux BTP", materialCatalogSubtitle: "Matériaux réutilisables dans les devis, factures, achats, stock et suivi chantier", defaultSupplier: "Fournisseur par défaut", purchasePriceHT: "Prix d'achat HT", purchasePriceTTC: "Prix d'achat TTC", totalMaterials: "Total matériaux", recentMovements: "Mouvements récents", stockEmptyTitle: "Aucun stock pour le moment", stockEmptyDescription: "Ajoutez des matériaux ou des mouvements pour alimenter ce tableau de bord.", noMaterialsCatalog: "Aucun matériau dans le catalogue" },
  ...
  profile: { ...arDict.profile, title: "Mon profil", subtitle: "Informations du compte utilisateur uniquement. Les informations société restent hors profil.", fullName: "Nom complet", email: "Email", phone: "Téléphone", role: "Rôle", memberSince: "Membre depuis", accountSettings: "Paramètres du compte", preferredLanguage: "Langue préférée", passwordChange: "Changer le mot de passe", lastLogin: "Dernière connexion", photo: "Photo", userInfo: "Informations utilisateur", passwordHelp: "Gérez le mot de passe de votre compte utilisateur.", securitySubtitle: "Gérez le mot de passe et l'accès au compte.", currentPassword: "Mot de passe actuel", newPassword: "Nouveau mot de passe", passwordUpdated: "Mot de passe mis à jour. Reconnectez-vous sur les autres appareils.", passwordUpdateFailed: "Impossible de modifier le mot de passe. Vérifiez le mot de passe actuel puis réessayez.", status: "Statut", roles: "Rôles", created: "Créé" },
};
...
const en: Partial<Dict> = {
  ...
  actions: { ...arDict.actions, new: "New", create: "Create", save: "Save", edit: "Edit", update: "Update", delete: "Delete", cancel: "Cancel", close: "Close", search: "Search", filter: "Filter", upload: "Upload", download: "Download", view: "View", saving: "Saving...", loading: "Loading...", uploading: "Uploading...", retry: "Retry" },
  labels: { ...arDict.labels, name: "Name", email: "Email", phone: "Phone", address: "Address", notes: "Notes", description: "Description", date: "Date", status: "Status", type: "Type", category: "Category", none: "None", noData: "No data", noResults: "No results", success: "Success" },
  ...
  stock: { ...arDict.stock, title: "Stock", materials: "Materials", categories: "Categories", newMaterial: "New Material", currentQty: "Current Qty", lowStock: "Low Stock", movements: "Movements", materialCatalog: "Construction Material Catalog", materialCatalogSubtitle: "Reusable materials for quotes, invoices, purchases, stock and construction tracking", defaultSupplier: "Default Supplier", purchasePriceHT: "Purchase Price HT", purchasePriceTTC: "Purchase Price TTC", totalMaterials: "Total Materials", recentMovements: "Recent Movements", stockEmptyTitle: "No stock yet", stockEmptyDescription: "Add construction materials or stock movements to populate this dashboard.", noMaterialsCatalog: "No materials in the catalog" },
  ...
  profile: { ...arDict.profile, title: "My Profile", subtitle: "Only personal account information. Company information stays outside the profile.", fullName: "Full name", email: "Email", phone: "Phone", role: "Role", memberSince: "Member since", accountSettings: "Account Settings", preferredLanguage: "Preferred Language", passwordChange: "Change Password", lastLogin: "Last Login", photo: "Photo", userInfo: "User Information", passwordHelp: "Manage your user account password.", securitySubtitle: "Manage password and account access.", currentPassword: "Current password", newPassword: "New password", passwordUpdated: "Password updated. Please sign in again on other devices.", passwordUpdateFailed: "Password could not be updated. Please verify your current password and try again.", status: "Status", roles: "Roles", created: "Created" },
};
