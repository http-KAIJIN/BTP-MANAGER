...
const permissions = [
  ...
  ["stock.create", "Create stock records"],
  ["stock.update", "Update stock records"],
  ["stock.archive", "Archive stock records"],
  ["ocr.scan", "Scan documents with OCR"],
  ["ocr.confirm", "Confirm OCR extraction"],
  ["ocr.usage", "View OCR usage"],
  ["ocr.settings", "Manage OCR settings"],
